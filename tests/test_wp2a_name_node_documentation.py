...
def test_status_marks_only_wp2a_lab_scope_implemented() -> None:
    ...
    assert "WP8 Tasks 2-4 implement operator/key authority, ownership, closed scope algebra, bounded delegation chains" in status
    assert "threshold-set transport packaging, Task 5 runtime, live federation, and global federation are not implemented" in status
