...
def command_matrix() -> list[Command]:
    ...
    return [
        ...
        Command(
            "f75-manifest", (python, "scripts/generate_wp8_f75_vectors.py", "--check", "vectors/wp8-f75-route-open"), manifest_gate=True
        ),
        Command(
            "local-admission-attestations", (python, "scripts/generate_wp8_local_admission_attestations.py", "--check"), manifest_gate=True
        ),
        Command(
            "federation-v01-manifest",
        ...
        Command(
            "federation-python",
            (python, "-m", "pytest", "tests/federation", "--ignore=tests/federation/test_independent_wire_peer.py", "-q"),
            count_mode="pytest",
        ),
        Command(
            "wp7-python",
            (
                ...
                "-m",
                "pytest",
                "tests/test_wp7_admission.py",
                "tests/test_wp7_conformance.py",
                "tests/test_wp7_review_fixes.py",
                "-q",
            ),
            count_mode="pytest",
        ),
        ...
        Command(
            "full-python", (python, "-m", "pytest", "--ignore=tests/federation/test_independent_wire_peer.py", "-q"), count_mode="pytest"
        ),
