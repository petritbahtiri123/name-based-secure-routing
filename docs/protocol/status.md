...
| Tranche 2B ACP authority wire (Acquire/Renew/Freshness, HTTP/2) | Frozen — Approved for implementation | FROZEN for frozen profile: `/acp/authority`, mandatory TLS 1.3, deterministic CBOR/COSE envelopes, and dedicated result signer purpose. Enrollment and enrollment design remain not yet frozen. |
